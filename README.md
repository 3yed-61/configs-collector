...
جهت مشاهده جزییات هر پروتکل، کدهای QR و گزینه‌های درون‌ریزی سریع، روی عنوان پروتکل مورد نظر کلیک کنید تا پنل مربوطه باز شود.
</p>
...
<details>
  ...
  <div align="center">
    ...
    <br><br>
    <p dir="rtl"><b>📥 درون‌ریزی مستقیم به نرم‌افزار:</b></p>
